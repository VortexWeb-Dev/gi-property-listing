...
<script>
    ...
    function handleAddAgent(e) {
        ...
        const fields = {
            "ufCrm38AgentId": data.pfId.trim(),
            "ufCrm38AgentName": data.agentName.trim(),
            "ufCrm38AgentEmail": data.agentEmail.trim(),
            "ufCrm38AgentMobile": data.agentMobile.trim(),
            "ufCrm38AgentLicense": data.agentLicense.trim(),
            "ufCrm38AgentPhoto": data.agentPhoto.trim(),
        };
