...
<script>
    ...
    async function fetchProperty(id) {
        ...
        if (data.result && data.result.item) {
            ...
            document.getElementById('property-title').textContent = property.ufCrm37TitleEn || 'No title available';
            document.getElementById('property-description').innerHTML = '<pre>' + property.ufCrm37DescriptionEn + '</pre>' || 'No description available';
            document.getElementById('property-city').textContent = property.ufCrm37City || 'N/A';
            document.getElementById('property-community').textContent = property.ufCrm37Community || 'N/A';
            let priceText = property.ufCrm37Price ? formatPrice(property.ufCrm37Price) : 'N/A';
            if (property.ufCrm37RentalPeriod && property.ufCrm37RentalPrice) {
                ...
                const rentalPeriod = rentalPeriodMapping[property.ufCrm37RentalPrice] || property.ufCrm37RentalPeriod;
                priceText += `/ ${rentalPeriod}`;
            }
            document.getElementById('property-price').textContent = priceText;
            document.getElementById('property-size').textContent = property.ufCrm37Size ? `${property.ufCrm37Size} sqft` : 'N/A';
            document.getElementById('property-bedrooms').textContent = property.ufCrm37Bedroom || 'N/A';
            document.getElementById('property-bathrooms').textContent = property.ufCrm37Bathroom || 'N/A';
            document.getElementById('property-type').textContent = property.ufCrm37PropertyType || 'N/A';
            document.getElementById('property-location').textContent = property.ufCrm37Location || 'N/A';
            document.getElementById('property-status').textContent = property.ufCrm37Status || 'N/A';
            document.getElementById('property-owner').textContent = property.ufCrm37ListingOwner || 'N/A';
            document.getElementById('agent-name').textContent = property.ufCrm37AgentName || 'N/A';
            document.getElementById('agent-phone').textContent = property.ufCrm37AgentPhone || 'N/A';
            document.getElementById('agent-email').textContent = property.ufCrm37AgentEmail || 'N/A';
            document.getElementById('main-image').src = property.ufCrm37PhotoLinks[0] || 'https://placehold.jp/150x150.png';

            const images = property.ufCrm37PhotoLinks || [];
            ...
            const comments = property.ufCrm37Notes || [];
